...
TEMPLATE_FILE = "phone_device_template_bot.json"
...
def build_add_bot_phone_soap(user_details, new_phone_name, dn_pattern, dn_partition, template):
    optional_fields = []
    ...
    description = f"BOT {display_name}".strip()
